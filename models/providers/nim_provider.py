"""
JARVIS V2 - NVIDIA NIM Provider
High-throughput specialized endpoints for Vision, Gemma, and Reasoning.
"""
import json
...
class NIMProvider(BaseProvider):
    def __init__(self):
        self.api_key = config.NIM_API_KEY or config.NIM_VISION_API_KEY or config.NIM_GEMMA_API_KEY or config.NIM_QWEN_API_KEY
        self.client = OpenAI(api_key=self.api_key, base_url="https://integrate.api.nvidia.com/v1", timeout=6.0) if OpenAI and self.api_key and "your_" not in self.api_key else None
