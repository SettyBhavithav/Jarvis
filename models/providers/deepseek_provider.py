"""
JARVIS V2 - DeepSeek Provider
Specialized reasoning engine supporting deepseek-chat and deepseek-reasoner with thinking tokens.
"""
import json
...
class DeepSeekProvider(BaseProvider):
    def __init__(self):
        ...
        base_url = "https://integrate.api.nvidia.com/v1" if self.api_key and "nvapi-" in self.api_key else "https://api.deepseek.com/v1"
        self.client = OpenAI(api_key=self.api_key, base_url=base_url, timeout=6.0) if OpenAI and self.api_key and "your_" not in self.api_key else None
