<div align="center">
  ...
  <img src="https://img.shields.io/badge/AI-Multi--Modal-purple?style=for-the-badge" alt="AI" />
  <h1>🤖 JARVIS: Autonomous Multi-Modal AI Assistant</h1>
</div>

---

## ⚡ What is Jarvis?
Jarvis is a highly customized, ultra-low-latency, autonomous personal AI agent built specifically for a Windows environment. Unlike standard chatbots, Jarvis acts as a true digital companion that can **see your screen, hear your voice, control your local operating system, remember personal facts forever, and be controlled remotely via your phone.** 

It utilizes a **Hybrid Architecture** that balances the zero-cost privacy of local computing with the massive intelligence and speed of Cloud AI.

---

## 🚀 Key Features
* 🧠 **Dynamic Brain Routing:** Automatically analyzes your prompt and routes to the most efficient LLM (e.g., DeepSeek for coding, Groq LPU for fast chat, NVIDIA NIM for vision, Ollama for offline fallback).
* 🗣️ **True Voice Interruption:** Jarvis's microphone unlocks while he is speaking. If you interrupt him, he instantly purges his TTS queue, halts the physical speaker, and employs an acoustic echo delay for a flawless conversational experience.
* 👀 **Implicit Screen Awareness:** Say *"What is this error?"* and Jarvis autonomously takes a silent screenshot and uses NVIDIA NIM Vision to explain what is on your desktop.
* 🌐 **Headless Web Scraping:** Jarvis can spin up an invisible Playwright browser, bypass strict locators, extract raw text, and summarize entire websites.
* 📧 **Autonomous Background Emailing:** Authenticated via the Gmail API to write and send formal emails silently in the background.
* 🧠 **RAG Long-Term Memory:** Converts facts into mathematical vectors locally and saves them to MongoDB Atlas, retrieving context instantly for future conversations.
* 📱 **Discord "OpenClaw" Interface:** Text Jarvis from anywhere in the world using Discord, and he will execute commands on your home PC.
* 🎵 **Media Orchestrator:** Controls Spotify and Windows media (Play, Pause, Next) with zero latency via OS keyboard hooks.
* 📺 **Autonomous YouTube Chaining:** Jarvis can open YouTube, grab video URLs, download transcripts, and provide bullet-point summaries in seconds.

---

## 🏗️ Technical Architecture

This massive 9-Phase flowchart documents every model, library, and data stream in the Jarvis ecosystem.
...
To deploy Jarvis on your local Windows machine:
...
3. **Configure the Environment:**
   ...
   * Fill in your API keys for **Groq**, **DeepSeek**, **NVIDIA NIM**, and **Gemini**.
   * Add your **Discord Bot Token** and **MongoDB URI**.

4. **Google Authentication:**
   * Download your `credentials.json` from the Google Cloud Console (with Calendar and Gmail API enabled) and place it in the root directory.
   * On first run, a browser window will pop up. Login to grant Jarvis permission.
...
---
*Built autonomously using advanced AI Multi-Modal processing. Refer to `About_Project.txt` for deeper engineering insights into struggles and performance fixes.*
